...
fun dummyData() {
    println("testdata loaded")
    placemarks.add(PlacemarkModel(1,"New York", "USA"))
    placemarks.add(PlacemarkModel(2,"Dublin", "IRELAND"))
    placemarks.add(PlacemarkModel(3,"Cardiff", "WALES"))
}
